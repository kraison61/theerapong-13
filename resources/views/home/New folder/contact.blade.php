...
{{-- ============ NAV ============ --}}
<header class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-line" x-data="{ open: false }">
    <nav class="mx-auto max-w-7xl px-6 h-[68px] flex items-center justify-between gap-4">
        ...
        <div class="hidden lg:flex items-center gap-1 text-[15px] font-medium text-ink2">
            ...
            <a href="{{ route('about') }}"           class="px-3.5 py-2 rounded-lg text-navy-900 bg-surface font-semibold">เกี่ยวกับเรา</a>
    ...
    <div x-show="open" x-cloak
        ...
        <div class="mx-auto max-w-7xl px-6 py-3 flex flex-col text-[15px] font-medium text-ink2">
            ...
            <a href="{{ route('about') }}"           @click="open=false" class="py-2.5 border-b border-line/70 font-semibold text-navy-900">เกี่ยวกับเรา</a>
...
<section class="relative overflow-hidden bg-navy-900 text-white">
    {{-- Decorative blobs --}}
    <div class="pointer-events-none absolute -top-32 -right-32 h-[560px] w-[560px] rounded-full bg-navy-700/40 blur-3xl"></div>
    <div class="pointer-events-none absolute bottom-0 left-0 h-[320px] w-[320px] rounded-full bg-accent/10 blur-3xl"></div>
    ...
    <div class="relative mx-auto max-w-7xl px-6 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
            ...
            <p class="mt-5 text-lg leading-relaxed text-white/70 max-w-xl">
                เราไม่ใช่แค่ผู้รับเหมา — เราเป็น <strong class="text-white font-semibold">พาร์ทเนอร์ด้านก่อสร้าง</strong>
        ...
        <div class="relative">
            <div class="relative aspect-[4/5] overflow-hidden rounded-2xl shadow-2xl shadow-navy-950/60">
                <img
                    ...
                    alt="ทีมงานธีรพงษ์การช่าง หน้างานก่อสร้าง"
            ...
            {{-- Floating stats --}}
            <div class="absolute -left-4 top-10 hidden sm:flex items-center gap-3 rounded-xl bg-white p-3 pr-4 shadow-2xl ring-1 ring-line">
            ...
            <div class="absolute -right-4 bottom-24 hidden sm:flex items-center gap-3 rounded-xl bg-white p-3 pr-4 shadow-2xl ring-1 ring-line">
    ...
    <div class="mx-auto max-w-7xl px-6 py-20 lg:py-28">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-navy-900 text-white p-8 flex flex-col">
                <div class="absolute -top-12 -right-12 w-40 h-40 rounded-full bg-navy-700/50 blur-2xl group-hover:scale-150 transition duration-700"></div>
                <span class="relative grid place-items-center w-14 h-14 rounded-xl bg-white/10 text-white text-2xl mb-6">
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-line bg-white p-8 flex flex-col hover:border-navy-900 hover:shadow-2xl hover:shadow-navy-900/8 transition">
        ...
        <div class="relative order-2 lg:order-1">
            <div class="relative aspect-square overflow-hidden rounded-2xl shadow-xl shadow-navy-900/15">
                <img
                    ...
                    alt="หน้างานก่อสร้างธีรพงษ์การช่าง"
                    class="h-full w-full object-cover"
                />
            </div>
            {{-- Overlay card --}}
            <div class="absolute inset-x-5 bottom-5 rounded-xl bg-white/95 backdrop-blur p-4 shadow-xl flex items-center gap-4">
            ...
            <ol class="mt-8 space-y-5">
                ...
                @foreach ($milestones as $m)
                    <li class="flex gap-4 items-start">
                        <span class="shrink-0 grid place-items-center w-14 h-8 rounded-full bg-navy-900 text-white font-mono text-xs font-bold tabular-nums">
                            {{ $m['year'] }}
                        </span>
    ...
    <div class="mx-auto max-w-7xl px-6 py-20 lg:py-28">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            @foreach ($expertise as $item)
                <div class="rounded-2xl bg-navy-800/60 ring-1 ring-white/10 p-6 flex flex-col gap-4 hover:bg-navy-800 transition">
        ...
        <div class="mt-10 pt-8 border-t border-white/10 flex flex-wrap gap-3">
            ...
            @foreach ($certs as $cert)
                <span class="inline-flex items-center gap-2 rounded-full bg-white/8 ring-1 ring-white/15 px-3.5 py-2 text-[13px] text-white/75">
    ...
    <div class="mx-auto max-w-7xl px-6 py-16 lg:py-20 flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div class="flex flex-wrap gap-3 shrink-0">
            ...
            <flux:button
                href="tel:0812345678"
                variant="outline"
                class="rounded-xl border-white/30 text-white hover:bg-white/10 px-7 py-3.5 font-semibold transition"
            ><i class="bi bi-telephone-fill mr-1.5"></i> 081-234-5678</flux:button>
        </div>
    </div>
</section>
    ...
    <div class="mx-auto max-w-7xl px-6 pt-16 pb-10 grid md:grid-cols-12 gap-10">
        ...
        <div class="md:col-span-2">
            ...
            <ul class="space-y-2.5 text-[15px]">
                @php
                    $footerServices = [
                        ['slug' => 'wall',  'name' => 'กำแพงกันดิน'],
                        ['slug' => 'fence', 'name' => 'รั้วบ้าน'],
                        ['slug' => 'road',  'name' => 'ถนน & ทางเข้าบ้าน'],
                        ['slug' => 'slab',  'name' => 'ลานคอนกรีต'],
                        ['slug' => 'drain', 'name' => 'ระบบระบายน้ำ'],
                        ['slug' => 'land',  'name' => 'ปรับพื้นที่ & ถมดิน'],
                    ];
                @endphp
        ...
        <div class="md:col-span-2">
            ...
            <ul class="space-y-2.5 text-[15px]">
                <li><a href="{{ route('about') }}"           class="text-white/85 font-medium hover:text-white transition">เกี่ยวกับเรา</a></li>
                <li><a href="{{ route('home') }}#projects"   class="hover:text-white transition">ผลงานก่อสร้าง</a></li>
                <li><a href="{{ route('home') }}#process"    class="hover:text-white transition">ขั้นตอนทำงาน</a></li>
